 ...
 * clients and our buttons.
 */
class CAccProxyObject : public IAccessible
{
public:
    CAccProxyObject(LPUGLYBUTTONDATA pButtonData);
    ~CAccProxyObject();
    ...
    /**
     * NULLs out the ugly button data object. This should be done for cases where
